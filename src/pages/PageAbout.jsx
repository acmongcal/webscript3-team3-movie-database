    ...
    <section>
      ...
      <article>
        <p>
          ...
          releases, and hidden gems, making it simple to find your next movie to
          watch.
        </p>
        <p>
        ...
        <p>
          {" "}
          We believe every anime movie has a story worth discovering. That's why
          we're committed to building a reliable database where fans can explore
          new releases, revisit timeless classics, and learn more about the
          films and creators behind them.
        </p>
      </article>
    </section>
  );
